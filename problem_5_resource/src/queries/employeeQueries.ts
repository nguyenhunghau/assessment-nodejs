...
export const employeeQueries = {
    ...
    getEmployees: async (options?: { limit?: number; offset?: number }): Promise<{ data: Employee[]; total: number }> => {
    ...
    updateEmployee: async (id: number, updates: Partial<Omit<Employee, 'id' | 'created_at'>>): Promise<Employee | null> => {
