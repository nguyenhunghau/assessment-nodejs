...
const mockEmployeeQueries = employeeQueries as jest.Mocked<
  typeof employeeQueries
>;
...
describe('employeeService', () => {
  ...
  describe('createEmployee', () => {
    it('should create employee successfully', async () => {
      ...
      expect(mockEmployeeQueries.createEmployee).toHaveBeenCalledWith(
        employeeData
      );
    });
    ...
    it('should handle database errors', async () => {
      mockEmployeeQueries.createEmployee.mockRejectedValue(
        new Error('DB error')
      );
  ...
  describe('getEmployees', () => {
    it('should return list of employees', async () => {
      ...
      mockEmployeeQueries.getEmployees.mockResolvedValue({
        data: mockEmployees,
        total: 2,
      });
  ...
  describe('getEmployeeById', () => {
    ...
    it('should throw error if id is invalid', async () => {
      await expect(employeeService.getEmployeeById(0)).rejects.toThrow(
  ...
  describe('deleteEmployee', () => {
    ...
    it('should throw error if id is invalid', async () => {
      await expect(employeeService.deleteEmployee(0)).rejects.toThrow(
        'Valid employee ID is required'
      );
    });
